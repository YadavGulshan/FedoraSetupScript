...
if(input("Do you want to install Flutter?") != 0):
    ...
    system("wget https://r2---sn-hpjgvnj5o-cvhe.gvt1.com/edgedl/android/studio/ide-zips/4.2.2.0/android-studio-ide-202.7486908-linux.tar.gz?cms_redirect=yes&mh=Ug&mip=103.156.212.147&mm=28&mn=sn-hpjgvnj5o-cvhe&ms=nvh&mt=1625660895&mv=m&mvi=2&pcm2cms=yes&pl=24&rmhost=r3---sn-hpjgvnj5o-cvhe.gvt1.com&shardbypass=yes&smhost=r1---sn-hpjgvnj5o-cvhs.gvt1.com")
# system("")
# system("")
